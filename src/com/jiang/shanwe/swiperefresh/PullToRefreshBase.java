 ...
 *******************************************************************************/
package com.jiang.shanwe.swiperefresh;
...
import com.jiang.shanwe.swiperefresh.internal.FlipLoadingLayout;
import com.jiang.shanwe.swiperefresh.internal.LoadingLayout;
import com.jiang.shanwe.swiperefresh.internal.RotateLoadingLayout;
import com.jiang.shanwe.swiperefresh.internal.Utils;
import com.jiang.shanwe.swiperefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements
    ...
    protected final void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            mShowViewWhileRefreshing = bundle
                    .getBoolean(STATE_SHOW_REFRESHING_VIEW, true);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrMode)) {
            mMode = Mode
                    .mapIntToValue(a.getInteger(R.styleable.PullToRefresh_ptrMode, 0));
        }

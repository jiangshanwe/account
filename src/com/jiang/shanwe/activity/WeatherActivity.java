...
import com.jiang.shanwe.swiperefresh.PullToRefreshBase;
import com.jiang.shanwe.swiperefresh.PullToRefreshBase.OnRefreshListener;
import com.jiang.shanwe.swiperefresh.PullToRefreshScrollView;
...
public class WeatherActivity extends Activity {
    ...
    private void setWeatherView(WeatherBean bean) {
        ...
        if (futureList.size() == 3) {
            setFutureData(tv_tommorrow, iv_tommorrow_weather, tv_tommorrow_temp_a,
                    tv_tommorrow_temp_b, futureList.get(0));
            setFutureData(tv_thirdday, iv_thirdday_weather, tv_thirdday_temp_a,
                    tv_thirdday_temp_b, futureList.get(1));
            setFutureData(tv_fourthday, iv_fourthday_weather, tv_fourthday_temp_a,
                    tv_fourthday_temp_b, futureList.get(2));
        }
    ...
    private void setHourData(TextView tv_hour, ImageView iv_weather, TextView tv_temp,
